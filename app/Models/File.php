...
class File extends Model
{
     ...
     */
    public function uploadFile($privacidad, $file, $name, $extension)
    {
       
        $path = '/';
        $full_name = $name . '.' . $extension;

        return Storage::disk($privacidad)->putFileAs($path, $file, $full_name);
    }


    public function uploadIcono($file, $name)
    {
