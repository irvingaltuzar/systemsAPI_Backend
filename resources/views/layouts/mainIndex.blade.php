...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
    ...
    {{-- <img id="logo-dmi" src="{{asset('/img/logo-dmi.svg')}}"> --}}
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Grupo DMI Intranet 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Selecciona cerrar sesion para salir, vuelve pronto!!!</div>
  ...
  <script src="{{ asset('/customSB/js/sb-admin-2.js')}}"></script>

  <!-- Page level plugins -->
  <script src="{{ asset('/customSB/vendor/chart.js/Chart.min.js')}}"></script>
